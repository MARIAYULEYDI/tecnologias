    ...
    <v-row align="center" justify="center" class>
      <v-col cols="12" md="12" lg="12" sm="12" class="mb-0">
        ...
        <p
          ...
          style="font-size:95%"
        >Las aplicaciones de Realidad Virtual son aplicaciones que hacen uso de la realidad virtual (VR). <br> La Realidad Virtual es una experiencia sensorial inmersiva que simula de forma digital un entorno remoto.</p>
        <p
          class="google-font mt-0 mb-0"
          style="font-size:95%"
        >La Realidad Aumentada (RA) asigna la interacción entre ambientes virtuales y el mundo físico, posibilitando que ambos se entremezclen a través de un dispositivo tecnológico como webcams, teléfonos móviles (IOS o Android), tabletas, entre otros.</p>
      </v-col>
