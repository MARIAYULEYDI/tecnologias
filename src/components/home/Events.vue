        ...
        <v-row align="center" justify="center">
            <v-col cols="12" md="10" lg="10" sm="12" class="text-center mb-0" >
                <p class="google-font mb-1" style="font-weight: 350;font-size:180%">
                    <b>
                        Realidad
                        <span style="color: #1a73e8;">Virtual</span> 
                ...
                <p class="google-font mt-0" style="font-size:95%">La realidad virtual ha tenido un gran impacto en el mundo, ha llevado a todas las personas a conocer y ver otro limite de su imaginacion y hacer que todo esto sea tan real que vives nuevas experiencias.</p>
                <router-link
                    to="/events"
                    text
                    color="#4C4A78"
                    class="ma-0 google-font mb-0"
                    style="border-radius:5px;text-transform: capitalize;text-decoration:none;color:rgb(2,1,2,34,g)"
